...
<div class="col-lg-3">
				...
				<div class="cover_side">
					<div class="sidebar">
					<div class="profimg">
						<img alt="User_profile" src="./img/prof.png" height="220px" width="220px">
					</div>
						<span class="user"> <a href="#"><%out.print(session.getAttribute("Username"));%></a></span> 
						<center><b>User Dashboard</b></center>
							<span class="text">
								<div class="select">
...
<div class="col-lg-9">
					...
					<h3>Update User Details</h3>
						...
						<hr>
						<div class="frm-dlt-div">
						<form class="frmdlt">
							<h3>Delete Account</h3>
								<br>
							<input type="hidden" class="form-control" name="dltAcc" id="dltAcc"
